...
from contants import GAME_SCENE, GAMEOVER_SCENE, TIMER_EVENT
...
class GameOverScene(Scene):
    ...
    def __init__(self, clock, width, height):
        ...
        self.play_again_btn = pygame.Rect(self.width * 0.5 - 100, self.height - 100, 200, 50)
    ...
    def draw(self, screen):
        ...
        screen.blit(rotated_cathead,
                    (self.width * 0.5 - rotated_cathead_rect.width * 0.5,
                     self.height * 0.5 - rotated_cathead_rect.height * 0.5))
        ...
        pygame.draw.rect(screen, (255, 255, 255), self.play_again_btn)
        draw_text('PLAY AGAIN', self.font, (0, 0, 0), screen, self.play_again_btn.x + 25, self.play_again_btn.y + 13)
...
class MainMenuScene(Scene):
    ...
    def draw(self, screen):
        super().draw(screen)
        screen.fill((0, 0, 0))
        draw_text('main menu', self.font, (222, 222, 222), screen, 20, 20)

        mx, my = pygame.mouse.get_pos()

        button_1 = pygame.Rect(self.width * 0.5 - 100, 100, 200, 50)
        button_2 = pygame.Rect(self.width * 0.5 - 100, 200, 200, 50)
